...
if __name__ == '__main__':
    rand_im1 = (torch.randint(0, 255, [4, 3, 256, 128], dtype=torch.float32) / 255.)
    rand_im2 = (torch.randint(0, 255, [4, 3, 256, 128], dtype=torch.float32) / 255.)
    losser = MS_SSIM(data_range=1., levels=4, channel=3)
